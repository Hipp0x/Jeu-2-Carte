...
<body>
	...
	if($cartescrees['c'] < 15) {
		...
		<h1><?php echo $_SESSION['pseudo'] ?>, il est temps d'ajouter des cartes à ton jeu !</h1>
		...
		<div class="all">
			...
			<div class="mess">
				...
				if(isset($_POST['envoie'])){
					include 'Include/verification_cartes2.php';
				}
				?>
			</div>
			<?php 
			if(isset($_POST['fin'])){
				header('LOCATION: modifier_le_jeu.php?jeu='.htmlspecialchars($_GET['jeu']));
			}
			?>
		</div>
		<?php
